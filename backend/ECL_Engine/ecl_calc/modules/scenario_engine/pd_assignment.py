...
class PDAssignmentFramework:
    ...
    def _map_pd(self) -> pd.DataFrame:
        ...
        for scenario in self.scenario_param['scenario']:
            ...
            self.cf_table[f'mapped_mpd_{scenario}'] = self.cf_table['mpd']
    ...
    def _pd_adjustment(self) -> pd.DataFrame:
        ...
        for scenario in self.scenario_param['scenario']:
            ...
            self.cf_table[f'applied_mpd_{scenario}'] = 1 - (
                (1-self.cf_table[f'mapped_mpd_{scenario}'])**(self.cf_table['remaining_life_of_the_quarter']))
