...
class MissingAdjustment:
    ...
    def _apply_missing_adjustment(self):
        ...
        # Convert final_stage to string type to match with Stage column
        self.loan_table['final_stage'] = self.loan_table['final_stage'].astype(
            str)
        self.missing_life_param['stage'] = self.missing_life_param['stage'].astype(
            str)
